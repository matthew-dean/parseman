...
/** True when the macro table proved the direct builder's triviaLog value dead. */
export function tableOmitsTriviaCapture(code: string): boolean {
  return (onlyNodeFlags(code) & 4) === 0
}
