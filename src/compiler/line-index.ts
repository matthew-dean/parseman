...
/**
 * Record newline offsets for a matched range. Intended for optional compiled
 * parsers that collect line starts while they consume terminals. The collector is
 * deliberately append-only: speculative parses never roll it back. Normalize once
 * at the driver boundary before doing offset→line/column lookup.
 */
