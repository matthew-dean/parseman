...
const jsonChart: Chart = {
  ...
  initGroup: {
    ...
    bars: [
      { label: 'Parséman (.compile())', us: 92.2,   color: C.compile },
      { label: 'Chevrotain',             us: 1207.5, color: C.chevrotain },
    ],
  },
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/466589,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/382012,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/311750,  color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/161094,  color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/127043,  color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/5675852, color: C.native },
      ],
    },
    {
      title: 'warm parse — medium  (1.8 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/16284,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/14828,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/10703,  color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/5086,   color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/4090,   color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/255939, color: C.native },
      ],
    },
    {
      title: 'warm parse — large  (12 kB)',
      bars: [
        { label: 'Peggy',                  us: 1e6/2110,   color: C.peggy },
        { label: 'Parséman (macro build)', us: 1e6/1775,   color: C.macroBuild },
        { label: 'Parséman (no compile)',  us: 1e6/1167,   color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/649,    color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/515,    color: C.chevrotain },
        { label: 'JSON.parse (native)',    us: 1e6/21972,  color: C.native },
      ],
    },
  ],
}
...
const csvChart: Chart = {
  ...
  initGroup: {
    title: 'initialization (one-time; others: no setup cost)',
    bars: [
      { label: 'Parséman (.compile())', us: 85.0, color: C.compile },
      { label: 'Chevrotain',             us: 954.4, color: C.chevrotain },
    ],
  },
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/2787249, color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/489174,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/423680,  color: C.noCompile },
        { label: 'Parsimmon',              us: 1e6/274591,  color: C.parsimmon },
        { label: 'Chevrotain',             us: 1e6/151043,  color: C.chevrotain },
      ],
    },
    {
      title: 'warm parse — large  (14.8 kB, 500 rows)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/14861,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/2292,   color: C.peggy },
        { label: 'Parsimmon',              us: 1e6/2211,   color: C.parsimmon },
        { label: 'Parséman (no compile)',  us: 1e6/2398,   color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/794,    color: C.chevrotain },
      ],
    },
  ],
}
...
const gqlChart: Chart = {
  ...
  initGroup: {
    title: 'initialization (one-time; others: no setup cost)',
    bars: [
      { label: 'Parséman (.compile())', us: 680.9,  color: C.compile },
      { label: 'Chevrotain',             us: 1312.7, color: C.chevrotain },
    ],
  },
  groups: [
    {
      ...
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/1103322, color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/413524,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/215602,  color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/228407,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/88312,   color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — medium  (336 bytes)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/169467, color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/62225,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/37002,  color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/38285,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/17306,  color: C.parsimmon },
      ],
    },
    {
      title: 'warm parse — large  (7.8 kB)',
      bars: [
        { label: 'Parséman (macro build)', us: 1e6/6697,  color: C.macroBuild },
        { label: 'Peggy',                  us: 1e6/2654,  color: C.peggy },
        { label: 'Parséman (no compile)',  us: 1e6/1383,  color: C.noCompile },
        { label: 'Chevrotain',             us: 1e6/1352,  color: C.chevrotain },
        { label: 'Parsimmon',              us: 1e6/630,   color: C.parsimmon },
      ],
    },
  ],
}
